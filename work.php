...
<header>
    <nav>
        <div id="logo"><img src="images/logo-colour-noText.svg" alt="logo"></div>
        <div class="deskNavItem"><a class="button" href="index.php">Home</a></div>
        <div class="deskNavItem"><a class="button" href="about.html">About</a></div>
        <div class="deskNavItem"><a class="button" href="contact.html">Contact</a></div>
