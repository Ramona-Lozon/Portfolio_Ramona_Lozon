...
<header>
    <nav>
        ...
        <div class="deskNavItem" id="workTop"><a class="button" href="#case-files-section">Work/Top</a></div>
        <div class="deskNavItem"><a class="button" href="#about-section">About</a></div>
        <div class="deskNavItem"><a class="button" href="#skills-section">skills</a></div>
        <div class="deskNavItem"><a class="button" href="#contact-section">Contact</a></div>
        ...
        <ul class="hamburger-dropdown">
            <li class="hover-item"><a class="button" href="#case-files-section">Work/Top</a></li>
            <li class="hover-item"><a class="button" href="#about-section">About</a></li>
            <li class="hover-item"><a class="button" href="#skills-section">skills</a></li>
            <li class="hover-item"><a class="button" href="#contact-section">Contact</a></li>
        </ul>
    </nav>
</header>
    ...
    <div class="lightbox-content">
        <h3 class="text main-title">More About Me</h3>
            ...
            <article id="contact-section" class="col-span-full">
                <h3 class="text underline main-title " id="contactTitle">Contact</h3>
            <!--Buttons-->
            <form class="input-form" id="contactForm" method="post" action="sendmail.php">
            ...
            <li class="icon insta-icon">
                ...
                <?xml version="1.0" encoding="UTF-8"?>
                    <svg id="Layer_4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                      ...
                      <g>
                        <path class="insta-4 insta-fill" d="M27.63,6.91h44.75c11.43,0,20.71,9.28,20.71,20.71v44.75c0,11.43-9.28,20.71-20.71,20.71H27.62c-11.43,0-20.71-9.28-20.71-20.71V27.63c0-11.43,9.28-20.71,20.71-20.71Z"/>
